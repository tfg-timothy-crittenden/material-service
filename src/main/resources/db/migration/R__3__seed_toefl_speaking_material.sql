...
INSERT INTO material (id, exam_family_id, material_node_id, title, description, version, created_at, updated_at)
VALUES (1, 1, null, 'TOEFL Practice Test 1', 'TOEFL Practice Test 1', 0, now(), now())
ON CONFLICT (id) DO UPDATE SET material_node_id=EXCLUDED.material_node_id, title=EXCLUDED.title, description=EXCLUDED.description, exam_family_id=EXCLUDED.exam_family_id;
